...
beforeAll(async () => {
  mongoServer = await MongoMemoryServer.create({
    binary: { downloadTimeout: 600000 }, // 10 minutes for download
    instance: { startupTimeout: 600000 } // 10 minutes for startup
  });
  const mongoUri = mongoServer.getUri();
  process.env.MONGO_URI = mongoUri; // Set before requiring the app
  app = require('../../src/index'); // Now require the app
